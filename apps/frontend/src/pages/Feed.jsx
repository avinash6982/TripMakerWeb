  ...
  return (
    <main className="feed-page">
      <section className="feed-hero">
        <h1 className="feed-hero-title">{t("feed.heroTitle")}</h1>
        <p className="feed-hero-subtitle">{t("feed.heroSubtitle")}</p>
      </section>
      <section className="container feed-section">
        ...
        <div className="feed-filter-bar">
          <form
            ...
            style={{ flex: 1, minWidth: 0, display: "flex", gap: "var(--space-3)", flexWrap: "wrap" }}
            onSubmit={(e) => {
              e.preventDefault();
          ...
          >
            ...
            />
            <button type="submit" className="btn primary feed-search-btn" aria-label={t("feed.filter")} title={t("feed.filter")}>
              ...
              <span className="feed-search-btn-text">{t("feed.filter")}</span>
            </button>
          </form>
        </div>
                  ...
                  <div className="feed-card-body">
                    ...
                    <div className="feed-card-actions" onClick={(e) => e.preventDefault()}>
                      ...
                      <button
                        ...
                        title={expandedCommentsId === trip.id ? t("feed.hideComments", "Hide comments") : t("feed.viewComments", "View comments")}
                        aria-label={expandedCommentsId === trip.id ? t("feed.hideComments", "Hide comments") : t("feed.viewComments", "View comments")}
                      >
