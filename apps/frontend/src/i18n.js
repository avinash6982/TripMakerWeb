  ...
  en: {
    translation: {
      ...
      tripPlanner: {
        ...
        aiChat: {
          title: "Plan with AI",
          intro: "Tell me where you want to go, how many days you have, and your pace (relaxed, balanced, or fast). I'll ask for anything missing, then build your itinerary.",
          firstTimeHint: "Try a destination like \"Armenia\" or \"3 days in Paris\" — I'll ask for details if needed.",
          firstTimeHintBefore: "Try ",
          firstTimeHintAfter: " — I'll ask for days and pace if needed.",
          placeholder: "e.g. Armenia, or 5 days in Tokyo, relaxed...",
      ...
      trips: {
        ...
        map: "Map",
        itineraryMapHint: "Day colors match the route lines on the map above.",
        ...
        prerequisitesEmpty: "No items yet. Add things to bring or prepare.",
        addPrerequisite: "Add item",
        prerequisiteTitle: "Title",
        prerequisiteTitlePlaceholder: "e.g. Passport, First aid kit",
        prerequisiteDescription: "Description",
        prerequisiteDescriptionPlaceholder: "Optional details",
        prerequisiteCategory: "Category",
        prerequisiteAssign: "Assign to",
        prerequisiteAssignTo: "Assign to someone",
        prerequisiteUnassign: "Unassign",
        prerequisiteMarkDone: "Mark as done",
        prerequisiteMarkPending: "Mark as pending",
        prerequisiteEdit: "Edit",
        prerequisiteDelete: "Delete",
        prerequisiteStatusPending: "Pending",
        prerequisiteStatusDone: "Done",
        prerequisiteCategoryDocuments: "Documents",
        prerequisiteCategoryClothing: "Clothing",
        prerequisiteCategoryElectronics: "Electronics",
        prerequisiteCategoryMedicine: "Medicine",
        prerequisiteCategoryOther: "Other",
        prerequisiteAddSuccess: "Item added.",
        prerequisiteUpdateSuccess: "Item updated.",
        prerequisiteDeleteSuccess: "Item removed.",
        prerequisiteDeleteConfirm: "Remove this item?",
        prerequisiteFilter: "Filter",
        prerequisiteFilterAll: "All",
      ...
      feed: {
        ...
        heroSubtitle: "Explore community-created itineraries.",
      ...
      profile: {
        ...
        sectionInterests: "Interests & Destinations",
        empty: {
